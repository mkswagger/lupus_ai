    ...
    <>
         <div className='flex flex-row justify-between w-screen h-14 bg-[#000113] items-center pl-5 sm:pl-5 md:pl-10'>
            ...
            <div className='flex h-full items-center'>
                ...
                <div className='flex h-full items-center cursor-pointer'>
                    <img src={logout} alt="support" className='h-full pt-5 pb-5 w-auto mr-4 sm:mr-4 md:mr-0'/>
                    <p className='font-bold text-white mr-2 sm:mr-2 ml-2 sm:ml-2 md:mr-10 hidden sm:hidden md:block hover:text-[#8233A8]'>Log Out</p>
                </div>
            </div>
        </div>
