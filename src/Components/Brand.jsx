...
function Brand() {
  return (
    <>
        ...
        <div className='bg-gray-900 font-bold pl-5 sm:pl-5 md:pl-10 pt-2  text-xs sm:text-xs md:text-md lg:pt-5 lg:text-lg text-white'>Let's monitor your finances and keep them secure. </div>
    </>
  )
}
